...
verifyCorner positionsX positionsO
    | verifyPositionsV2 6 positionsO &&  verifyPositionsV2 4 positionsX && verifyPositionsV2 1 positionsO && verifyPositions 3 (positionsX++positionsO) = "3"
    | verifyPositionsV2 6 positionsO &&  verifyPositionsV2 4 positionsX && verifyPositionsV2 7 positionsO && verifyPositions 9 (positionsX++positionsO) = "9"
    | verifyPositionsV2 4 positionsO &&  verifyPositionsV2 6 positionsX && verifyPositionsV2 9 positionsO && verifyPositions 7 (positionsX++positionsO) = "7"
    | verifyPositionsV2 4 positionsO &&  verifyPositionsV2 6 positionsX && verifyPositionsV2 3 positionsO && verifyPositions 1 (positionsX++positionsO) = "1"
    | verifyPositionsV2 2 positionsO &&  verifyPositionsV2 8 positionsX && verifyPositionsV2 7 positionsO && verifyPositions 1 (positionsX++positionsO) = "1"
    | verifyPositionsV2 2 positionsO &&  verifyPositionsV2 8 positionsX && verifyPositionsV2 9 positionsO && verifyPositions 3 (positionsX++positionsO) = "3"
    | verifyPositionsV2 8 positionsO &&  verifyPositionsV2 2 positionsX && verifyPositionsV2 3 positionsO && verifyPositions 9 (positionsX++positionsO) = "9"
    | verifyPositionsV2 8 positionsO &&  verifyPositionsV2 2 positionsX && verifyPositionsV2 1 positionsO && verifyPositions 7 (positionsX++positionsO) = "7"
    ...
    | verifyPositionsV2 6 positionsO &&  verifyPositions 4 positionsO && verifyPositions 5 positionsX && verifyPositions 4 (positionsX++positionsO) = "4"
    | verifyPositionsV2 4 positionsO &&  verifyPositions 6 positionsO && verifyPositions 5 positionsX && verifyPositions 6 (positionsX++positionsO) = "6"
    | verifyPositionsV2 2 positionsO &&  verifyPositions 8 positionsO && verifyPositions 5 positionsX && verifyPositions 8 (positionsX++positionsO) = "8"
    | verifyPositionsV2 8 positionsO &&  verifyPositions 2 positionsO && verifyPositions 5 positionsX && verifyPositions 2 (positionsX++positionsO) = "2"
